...
export function TechMarquee() {
  return (
    <section id="contact" className="relative py-24 overflow-hidden md:py-32">
      {/* Section Header */}
      <motion.div
      ...
      >
        <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-4">04 — TEXNIK ARSENAL</p>
      </motion.div>
